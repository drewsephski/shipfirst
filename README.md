...
ShipFirst is a free alternative to ShipFast, designed to simplify and optimize your shipping process. It’s built using modern web technologies like Next.js, Supabase, Stripe, LemonSqueezy, Drizzle ORM and Mailgun.
...
ShipFirst provides Docker configurations for both **development** and **production** environments. Below, you'll find the structure of the Docker files and the commands to get started.
...
For full documentation, visit: [ShipFirst Docs](https://shipfirst.drew.agency/docs)
...
Cooked for you with ❤️ by [Drew](https://drew.agency)
