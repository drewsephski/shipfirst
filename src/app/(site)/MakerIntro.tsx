        ...
        <div className="flex flex-col md:flex-row gap-8 items-start">
          ...
          <div className="space-y-4">
            ...
            <p className="text-base">
              ...
              to remove those roadblocks and help
              founders launch faster.
            </p>
          </div>
        </div>

        <div className="space-y-6">
          <p className="text-base">We created ShipFirst for 3 reasons:</p>
          ...
          <p className="text-base">
            Thousands of founders have used ShipFirst to{" "}
            <a
              href="#"
              className="text-white hover:text-gray-200 underline underline-offset-2"
            >
