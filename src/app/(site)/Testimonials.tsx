...
export default function TestimonialsPage() {
  const testimonials = [
    ...
    },
    {
      name: "Larry",
      rating: 5,
      text: "No more overthinking or endless configurations <span class='font-bold text-green-400'>Just clone, tweak, and launch.</span> ShipFirst made everything seamless and stress-free!t",
      role: "Founder",
      avatar:
    ...
    {
      name: "Gabriel",
      text: "ShipFirst is hands down <span class='font-bold text-blue-400'>the best open-source SaaS boilerplate! </span>it’s the ultimate launchpad for startups looking to move fast and break barriers.",
      role: "Developer",
      avatar:
    ...
    },
    {
      name: "Yitai Goh",
      rating: 4,
      text: "Without ShipFirst, I’d still be wrestling with Stripe and email configurations! <span class='font-bold text-purple-400'>It saved me countless hours </span>! and let me scale effortlessly. ⚡️",
      role: "Entrepreneur",
      avatar:
    ...
    {
      name: "Matt Merrick",
      text: "I launched with ShipFirst boilerplate and have <span class='font-bold text-pink-400'>landed 5 new customers</span>! Thanks @drew",
      role: "Founder",
      avatar:
    ...
    },
    {
      name: "Tom Friday",
      rating: 5,
      text: "I used ShipFirst to build my SaaS, and <span class='font-bold text-orange-400'>in just two weeks, I had my first MRR.</span> It made everything 10x easier.",
      role: "Maker",
      avatar:
    ...
    {
      name: "Alex Chen",
      text: "As a solo developer, ShipFirst has been a game-changer. I've <span class='font-bold text-indigo-400'>launched two products</span> in the past month alone!",
    ...
    },
    {
      name: "Emmil Mittov",
      rating: 5,
      text: "The ShipFirst boilerplate saved me <span class='font-bold text-red-400'>weeks of development time</span>. I'm now focusing on growing my user base instead of wrestling with code.",
      role: "SaaS Founder",
      avatar:
